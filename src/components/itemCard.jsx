...
export default function ItemCard(props) {
    ...
    return (
        <div className="flex flex-col mx-5 max-w-[204px]">
            <Link to={"../item/" + props.props.id} className="bg-white rounded-[22px] w-[196px] h-[232px] flex items-center justify-center self-center">
